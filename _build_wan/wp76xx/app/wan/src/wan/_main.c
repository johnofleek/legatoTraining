...
// Startup code for the executable 'wan'.
...
LE_SHARED const char* _wanComponent_le_data_ServiceInstanceName = "wan.wanComponent.le_data";
LE_SHARED const char* _wanComponent_le_cfg_ServiceInstanceName = "wan.wanComponent.le_cfg";
LE_SHARED const char* _wanComponent_le_mdc_ServiceInstanceName = "wan.wanComponent.le_mdc";
LE_SHARED const char* _wanComponent_le_mrc_ServiceInstanceName = "wan.wanComponent.le_mrc";
LE_SHARED const char* _wanComponent_le_sim_ServiceInstanceName = "wan.wanComponent.le_sim";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t wan_exe_LogSession;
LE_SHARED le_log_Level_t* wan_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    wan_exe_LogSession = log_RegComponent("wan_exe", &wan_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_wanComponent.so");
