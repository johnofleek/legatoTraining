 ...
 *
 * @warning Dependency between the @c cellNetService and @c dataConnectionService has been removed. A
 * data connection request will no longer ensure that the radio is on, or verify that the SIM is
 * valid and unlocked.
 *
