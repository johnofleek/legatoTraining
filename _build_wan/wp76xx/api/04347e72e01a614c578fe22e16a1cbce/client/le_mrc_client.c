...
)
{
    ...
    if (!le_mrc_UnpackNetRegState( &_msgBufPtr, &_msgBufSize,
                                               &state ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    // Unpack the remaining parameters
    le_mrc_Rat_t rat;
    if (!le_mrc_UnpackRat( &_msgBufPtr, &_msgBufSize,
                                               &rat ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    // Pack the input parameters
    LE_ASSERT(le_mrc_PackRat( &_msgBufPtr, &_msgBufSize,
                                                  rat ));
...
)
{
    ...
    // Unpack any "out" parameters
    if (statePtr &&
        (!le_mrc_UnpackNetRegState( &_msgBufPtr, &_msgBufSize,
                                               statePtr )))
    {
        goto error_unpack;
    }
...
)
{
    ...
    // Pack the input parameters
    LE_ASSERT(le_mrc_PackRatBitMask( &_msgBufPtr, &_msgBufSize,
                                                  ratMask ));
...
)
{
    ...
    // Unpack any "out" parameters
    if (ratMaskPtrPtr &&
        (!le_mrc_UnpackRatBitMask( &_msgBufPtr, &_msgBufSize,
                                               ratMaskPtrPtr )))
    {
        goto error_unpack;
    }
...
)
{
    ...
    // Pack the input parameters
    LE_ASSERT(le_mrc_PackBandBitMask( &_msgBufPtr, &_msgBufSize,
                                                  bandMask ));
...
)
{
    ...
    // Unpack any "out" parameters
    if (bandMaskPtrPtr &&
        (!le_mrc_UnpackBandBitMask( &_msgBufPtr, &_msgBufSize,
                                               bandMaskPtrPtr )))
    {
        goto error_unpack;
    }
...
)
{
    ...
    // Pack the input parameters
    LE_ASSERT(le_mrc_PackLteBandBitMask( &_msgBufPtr, &_msgBufSize,
                                                  bandMask ));
...
)
{
    ...
    // Unpack any "out" parameters
    if (bandMaskPtrPtr &&
        (!le_mrc_UnpackLteBandBitMask( &_msgBufPtr, &_msgBufSize,
                                               bandMaskPtrPtr )))
    {
        goto error_unpack;
    }
...
)
{
    ...
    // Pack the input parameters
    LE_ASSERT(le_mrc_PackTdScdmaBandBitMask( &_msgBufPtr, &_msgBufSize,
                                                  bandMask ));
...
)
{
    ...
    // Unpack any "out" parameters
    if (bandMaskPtrPtr &&
        (!le_mrc_UnpackTdScdmaBandBitMask( &_msgBufPtr, &_msgBufSize,
                                               bandMaskPtrPtr )))
    {
        goto error_unpack;
    }
...
)
{
    ...
    le_mrc_PciScanInformationListRef_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_mrc_PerformPciNetworkScan;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
// This function parses the message buffer received from the server, and then calls the user
// registered handler, which is stored in a client data object.
static void _Handle_le_mrc_PerformPciNetworkScanAsync
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    // Pull out additional data from the client data pointer
    le_mrc_PciNetworkScanHandlerFunc_t _handlerRef_le_mrc_PerformPciNetworkScanAsync = (le_mrc_PciNetworkScanHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
    ...
    // Call the registered handler
    if ( _handlerRef_le_mrc_PerformPciNetworkScanAsync != NULL )
    {
        _handlerRef_le_mrc_PerformPciNetworkScanAsync(listRef, contextPtr );
    }
    else
    {
        LE_FATAL("Error in client data: no registered handler");
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_mrc_PerformPciNetworkScanAsync;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
)
{
    ...
    le_mrc_PciScanInformationRef_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_mrc_GetFirstPciScanInfo;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_mrc_GetNextPciScanInfo;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
)
{
    ...
    le_mrc_PlmnInformationRef_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_mrc_GetFirstPlmnInfo;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_mrc_GetNextPlmnInfo;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_mrc_GetPciScanCellId;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_mrc_GetPciScanGlobalCellId;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_mrc_GetPciScanMccMnc;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_mrc_DeletePciNetworkScan;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
)
{
    ...
    // Unpack the result first
    if (!le_mrc_UnpackRat( &_msgBufPtr, &_msgBufSize, &_result ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    // Unpack any "out" parameters
    if (ratPtr &&
        (!le_mrc_UnpackRat( &_msgBufPtr, &_msgBufSize,
                                               ratPtr )))
    {
        goto error_unpack;
    }
...
// This function parses the message buffer received from the server, and then calls the user
// registered handler, which is stored in a client data object.
static void _Handle_le_mrc_AddNetRegRejectHandler
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    // Pull out additional data from the client data pointer
    le_mrc_NetRegRejectHandlerFunc_t _handlerRef_le_mrc_AddNetRegRejectHandler = (le_mrc_NetRegRejectHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;

    // Unpack the remaining parameters
    le_mrc_NetRegRejectInd_t networkRejectInd;
    if (!le_mrc_UnpackNetRegRejectInd( &_msgBufPtr, &_msgBufSize,
                                               &networkRejectInd ))
    {
        goto error_unpack;
    }
    ...
    // Call the registered handler
    if ( _handlerRef_le_mrc_AddNetRegRejectHandler != NULL )
    {
        _handlerRef_le_mrc_AddNetRegRejectHandler(networkRejectIndPtr, contextPtr );
    }
    else
    {
        LE_FATAL("Error in client data: no registered handler");
...
)
{
    ...
    le_mrc_NetRegRejectHandlerRef_t _result;
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_mrc_AddNetRegRejectHandler;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(GetCurrentSessionRef());
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_mrc_RemoveNetRegRejectHandler;
    _msgBufPtr = _msgPtr->buffer;
    _msgBufSize = _MAX_MSG_SIZE;
    ...
    le_ref_DeleteRef(_HandlerRefMap, handlerRef);
    _UNLOCK
    handlerRef = (le_mrc_NetRegRejectHandlerRef_t)clientDataPtr->handlerRef;
    le_mem_Release(clientDataPtr);
    LE_ASSERT(le_pack_PackReference( &_msgBufPtr, &_msgBufSize,
                                     handlerRef ));
...
)
{
    ...
    if (!le_mrc_UnpackJammingReport( &_msgBufPtr, &_msgBufSize,
                                               &report ))
    {
        goto error_unpack;
    }
    le_mrc_JammingStatus_t status;
    if (!le_mrc_UnpackJammingStatus( &_msgBufPtr, &_msgBufSize,
                                               &status ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    switch (msgPtr->id)
    {
        ...
        case _MSGID_le_mrc_PerformCellularNetworkScanAsync :
            ...
            break;
        case _MSGID_le_mrc_PerformPciNetworkScanAsync :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_le_mrc_PerformPciNetworkScanAsync, msgRef, clientDataPtr);
            break;
        case _MSGID_le_mrc_AddNetworkRejectHandler :
            ...
            break;
        case _MSGID_le_mrc_AddNetRegRejectHandler :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_le_mrc_AddNetRegRejectHandler, msgRef, clientDataPtr);
            break;
